...
namespace TareasMVC.Controllers
{
    ...
    public class ArchivosController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<ArchivoAdjunto>>>Post(
            int tareaId,
            //FromForm nos permite usar un formato especial a traves del cual podemos resivir data ya sea archivos como nombre, email, word, pdf, etc, así como colecciónes de archivos
            ...
            )
        {
            ...
            var archivosAdjuntos = resultados
                .Select((resultado, indice)=> new ArchivoAdjunto
                {
                    TareaId = tareaId,
